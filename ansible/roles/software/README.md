...
This role clones the [ilifu/software](https://github.com/ilifu/software.git) repository to `/software/software` and configures it for use with the cluster's admin group structure. The repository contains Ansible playbooks and configurations for managing scientific software installations across the cluster.
...
- **Git Clone** - Clones ilifu/software repository to `/software/software`
- **Mount Dependency** - Waits for `/software` mount point to be available
- **Proper Ownership** - Sets appropriate file permissions on cloned repository
